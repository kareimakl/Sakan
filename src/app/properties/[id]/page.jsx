      ...
      <div className="max-w-6xl mx-auto p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="flex gap-2">
            <Image
              src={property?.imagePaths?.[1] || "/no-image.jpg"}
              alt="Main Image"
              width={800}
              height={400}
              className="rounded-lg md:w-[150px] w-[100px] h-[100px] object-cover"
            />

            <Image
              src={property?.imagePaths?.[2] || "/no-image.jpg"}
              alt="Main Image"
              width={800}
              height={400}
              className="rounded-lg md:w-[150px] w-[100px] h-[100px] object-cover"
        ...
        <aside className="space-y-6">
          ...
          <div className="bg-gray-100 p-4 rounded">
            ...
            <p className="text-sm text-gray-600 mb-2">{property.locationdto}</p>
            <iframe
              src={`https://maps.google.com/maps?q=${property.latitudedto},${property.longitudedto}&z=15&output=embed`}
              width="100%"
              height="200"
              className="rounded"
              loading="lazy"
          ...
          <div className="relative w-full">
            <div className="bg-[#255685] text-white text-center py-3 rounded text-lg font-bold z-20 relative">
              Book Now
              <Link
